        ...
        \begin{overprint}
            ...
            \onslide<7>
                ...
                z):A\,|_{\mathcal{X}_4\cup\mathcal{X}_2
                    \cup\{A,B\}}\, 
                \mathcal{C}_{4}\cup\mathcal{C}_{2}\cup\{B=S_2\rightarrow 
                A, X = S_4 \rightarrow B\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y \vdash 
                    \lambda z:Z.  ((x\, z)\, (y \, z)):Z \rightarrow A 
            ...
            \onslide<8>
                ...
                (x\, z)\, (y \, z):A\,|_{\mathcal{X}_2
                    \cup\{A,B\}}\, 
                \mathcal{C}_{2}\cup\{B=S_2\rightarrow A, X = Z 
                \rightarrow B\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y \vdash 
                    \lambda z:Z.  ((x\, z)\, (y \, z)):Z \rightarrow A 
                    \,|_{\mathcal{X}_2
...
%                            \end{tabular}\\
                ...
                z):A\,|_{\mathcal{X}_5\cup\mathcal{X}_6
                    \cup\{A,B,C\}}\, 
                \mathcal{C}_5\cup\mathcal{C}_6\cup\{B=C\rightarrow A, 
                X = Z \rightarrow B, S_5 = S_6 \rightarrow C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y \vdash 
                    \lambda z:Z.  ((x\, z)\, (y \, z)):Z \rightarrow A 
                    \,|_{\mathcal{X}_5\cup\mathcal{X}_6
                        \cup\{A,B,C\}}\, 
                    \mathcal{C}_5\cup\mathcal{C}_6\cup\{B=C\rightarrow 
                    A, X = Z \rightarrow B, S_5 = S_6 \rightarrow 
                    C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X \vdash \lambda 
                    y:Y.\lambda z:Z.  ((x\, z)\, (y \, z)):Y 
                    \rightarrow Z\rightarrow 
...
%                            \end{tabular}\\
                ...
                (x\, z)\, (y \, z):A\,|_{\mathcal{X}_6
                    \cup\{A,B,C\}}\, \mathcal{C}_6\cup\{B=C\rightarrow 
                A, X = Z \rightarrow B, Y = S_6 \rightarrow C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y \vdash 
                    \lambda z:Z.  ((x\, z)\, (y \, z)):Z \rightarrow A 
                    \,|_{\mathcal{X}_6
                        \cup\{A,B,C\}}\, 
                    \mathcal{C}_6\cup\{B=C\rightarrow A, X = Z 
                    \rightarrow B, Y = S_6 \rightarrow C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X \vdash \lambda 
                    y:Y.\lambda z:Z.  ((x\, z)\, (y \, z)):Y 
                    \rightarrow Z\rightarrow 
...
%                            \end{tabular}\\
                    ...
                    \end{tabular}\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y, z:Z \vdash
                (x\, z)\, (y \, z):A\,|_{\{A,B,C\}}\, \{B=C\rightarrow 
                A, X = Z \rightarrow B, Y = Z \rightarrow C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X, y:Y \vdash 
                    \lambda z:Z.  ((x\, z)\, (y \, z)):Z \rightarrow A 
                    \,|_{\{A,B,C\}}\, \{B=C\rightarrow A, X = Z 
                    \rightarrow B, Y = Z \rightarrow C\}}}} $\\
                $\displaystyle {{{}\over{\Gamma, x:X \vdash \lambda 
                    y:Y.\lambda z:Z.  ((x\, z)\, (y \, z)):Y 
                    \rightarrow Z\rightarrow A\,|_{\{A,B,C\}}\, 
                    \{B=C\rightarrow A, X = Z \rightarrow B, Y = Z 
                    \rightarrow C\}}}}  $\\
                $\displaystyle {{}
                    \over{\Gamma \vdash \lambda x:X. \lambda y:Y.\lambda z:Z.
                    ((x\, z)\, (y \, z)):X \rightarrow Y \rightarrow 
                Z\rightarrow A\,|_{\{A,B,C\}}\, \{B=C\rightarrow A, X 
                = Z \rightarrow B, Y = Z \rightarrow C\}}} $
                \end{tabular}
            \onslide<12>
                \begin{tabular}{c}
                    \begin{tabular}{rl}
